...
CREATE TABLE `FRIENDLIST` (
  ...
  `friendlist_status` varchar(15) NOT NULL DEFAULT 'pending',
  `friendlist_timestamp_request_accepted` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `USERDETAILS` VALUES (1,'1','GUNJAN','ACHARYA','23456489','ABS@GMAIL.COM','ASD','m','0000-00-00','jkhjhl','kgvjjbk');
...
-- Dump completed on 2017-02-11 16:24:14
