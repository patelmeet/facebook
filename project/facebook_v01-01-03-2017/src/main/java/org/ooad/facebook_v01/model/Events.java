...
public class Events {
	...
	private int event_start_date;
	private int event_start_time;
	private int event_end_date;
	...
	public Events(int event_pk,String event_name,String event_location,int event_start_date,int event_start_time,int event_end_date,int event_end_time,String event_description,String event_photo)
	{
	...
	public int getEvent_start_date() {
		return event_start_date;
	}

	public void setEvent_start_date(int event_start_date) {
		this.event_start_date = event_start_date;
	}
	...
	public int getEvent_end_date() {
		return event_end_date;
	}

	public void setEvent_end_date(int event_end_date) {
		this.event_end_date = event_end_date;
	}
