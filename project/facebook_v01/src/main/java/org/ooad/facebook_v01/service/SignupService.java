...
//			System.out.println(check_query);
			...
			insert_query = "insert into userdetails values(NULL,'"+user.getUserDetails_userName()+"','"+user.getUserDetails_firstName()+"','"+user.getUserDetails_lastName()+"',NULL,'"+user.getUserDetails_email()+"','"+user.getUserDetails_password()+"','"+user.getUserDetails_gender()+"','"+birth_date+"','vdxv','sdc')";
...
//			System.out.println(check_query);
			...
			insert_query = "insert into userdetails values(NULL,'"+user.getUserDetails_userName()+"','"+user.getUserDetails_firstName()+"','"+user.getUserDetails_lastName()+"','"+user.getUserDetails_mobile()+"',NULL,'"+user.getUserDetails_password()+"','"+user.getUserDetails_gender()+"','"+birth_date+"','vdxv','sdc')";
			dbconn.getStmt().executeUpdate(insert_query);
			rs.close();
			return 0;
		}
