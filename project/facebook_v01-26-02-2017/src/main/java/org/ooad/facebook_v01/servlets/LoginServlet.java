...
//        	System.out.println(new JSONObject().append("pk",usr.getUserDetails_pk()).toString());
//        	response.getWriter().write(new JSONObject().append("pk",usr.getUserDetails_pk()).toString());
...
//        	response.sendRedirect("ViewPersonalInfo.html");
        	...
        	response.setHeader("mystatus","206");
        }
        else{
        	//OTHER ERROR
