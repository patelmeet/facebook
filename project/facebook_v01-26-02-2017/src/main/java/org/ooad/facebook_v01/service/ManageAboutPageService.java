...
public class ManageAboutPageService {
	...
	public int newCollege(int user_id, College clg) throws SQLException {
		...
		ResultSet rs;
		String query = "insert into facebook_v01.COLLEGE (college_name,college_start_year,college_end_year,college_graduated,college_description,college_concentration,college_attended_for,userdetails_pk) values ('"
	...
	public int editCollege(College clg) throws SQLException {
		...
		ResultSet rs;
		String query = "update facebook_v01.COLLEGE set college_name='" + college_name + "', college_start_year="
	...
	public int getCollege(int user_id, ArrayList<College> colleges) throws SQLException {
		...
		ResultSet rs;
		String query = "SELECT * FROM facebook_v01.COLLEGE where userdetails_pk=" + user_id + ";";
		rs = dbconn.getStmt().executeQuery(query);
	...
	public int newSchool(int user_id, School school) throws SQLException {
		...
		ResultSet rs;
		String query = "insert into facebook_v01.SCHOOL (school_name,school_start_year,school_end_year,school_description,userdetails_pk) values ('"
	...
	public int getSchool(int user_id, ArrayList<School> schoollist) throws SQLException {
		...
		while (rs.next()) {
			...
			school.setSchool_description(rs.getString("college_description"));
			school.setSchool_end_year(Integer.parseInt(rs.getString("college_end_year")));
			school.setSchool_name(rs.getString("college_name"));
			school.setSchool_pk(Integer.parseInt(rs.getString("college_pk")));
			school.setSchool_start_year(Integer.parseInt(rs.getString("college_start_year")));
